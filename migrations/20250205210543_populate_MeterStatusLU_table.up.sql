INSERT INTO public."MeterStatusLU" (id, status_name, description) VALUES
    ...
    ('8', 'On Hold', 'Meter is on hold and will be re-installed at previous site.')
    ON CONFLICT (id) DO NOTHING;

SELECT
    setval ('public."MeterStatusLU_id_seq"', 8, true);
