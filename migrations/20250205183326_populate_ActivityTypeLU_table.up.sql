INSERT INTO
    public."ActivityTypeLU" (id, name, description, permission)
VALUES
    (
        1,
        'Install',
        'Install meter at a location',
        'technician'
    ),
    (
        2,
        'Uninstall',
        'Remove meter from a location',
        'technician'
    ),
    (
        4,
    ...
    (
        6,
        'Rate Meter',
        'Test meter with known flow rate',
        'technician'
    ),
...
SELECT
    setval ('public."ActivityTypeLU_id_seq"', 12, true);
