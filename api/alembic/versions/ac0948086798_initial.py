...
def upgrade():
    ...
    op.create_index(
        op.f("ix_ObservedProperty_id"), "ObservedProperty", ["id"], unique=False
    )
    op.create_table(
        "Owner",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_WellConstruction_id"), "WellConstruction", ["id"], unique=False
    )
    op.create_table(
        "WellMeasurement",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_WellMeasurement_id"), "WellMeasurement", ["id"], unique=False
    )
    op.create_table(
        "Alert",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_RepairPartAssociation_id"),
        "RepairPartAssociation",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_ScreenInterval_id"), "ScreenInterval", ["id"], unique=False
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_RepairPartAssociation_id"), table_name="RepairPartAssociation"
    )
    ...
    op.drop_index(
        "idx_Well_geom", table_name="Well", postgresql_using="gist", postgresql_ops={}
    )
    op.drop_table("Well")
