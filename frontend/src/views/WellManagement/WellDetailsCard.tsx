    ...
    <Card>
      ...
      <CardContent>
          ...
          <Grid container item xs={12} spacing={2}>
            <Grid item xs={6}>
              <ControlledSelect
                ...
                getOptionDisabled={(status_type: WellStatus) =>
                  status_type.status == "plugged"
                }
                control={control}
              />
            </Grid>
            ...
            <Stack direction="row" spacing={2}>
              {formStateHasErrors() ? (
                ...
                <Button
                  color="success"
                  variant="contained"
                  onClick={handleSubmit(onAddWell, onError)}
                >
                ...
                <Button
                  color="success"
                  variant="contained"
                  onClick={handleSubmit(onSaveChanges, onError)}
                >
        ...
        <MergeWellModal
          ...
          handleSuccess={() => {
            enqueueSnackbar("Successfully Merged Well!", {
              variant: "success",
            });
            reset();
          }}
